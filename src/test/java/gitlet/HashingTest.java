...
public class HashingTest {
    ...
    void emptyByteResultsInCorrectHash() throws Exception{
        ...
        String hex = Hashing.sha1HashString(bytes);
    ...
    void sameInputSameOutput() throws Exception{
        ...
        String testHex1 = Hashing.sha1HashString(testString);
        String testHex2 = Hashing.sha1HashString(testString);
    ...
    void diffInputDiffOutput() throws Exception{
        ...
        String testHex1 = Hashing.sha1HashString(testString1);
        String testHex2 = Hashing.sha1HashString(testString2);
